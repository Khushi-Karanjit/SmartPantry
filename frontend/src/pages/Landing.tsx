...
export default function Landing() {
  ...
  const opacity1 = useTransform(scrollY, [0, 600], [0.9, 0.4]);
  const opacity2 = useTransform(scrollY, [200, 800], [0.85, 0.3]);
  const opacity3 = useTransform(scrollY, [400, 1000], [0.8, 0.3]);
  const opacity4 = useTransform(scrollY, [600, 1200], [0.9, 0.4]);
  const opacity5 = useTransform(scrollY, [0, 500], [0.8, 0.3]);
  const opacity6 = useTransform(scrollY, [300, 900], [0.75, 0.2]);
  const opacity7 = useTransform(scrollY, [100, 700], [0.85, 0.3]);
  const opacity8 = useTransform(scrollY, [500, 1100], [0.8, 0.3]);
  ...
  return (
    <div className="relative min-h-screen bg-white text-slate-900">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden opacity-100">
         <motion.img style={{ y: y1, x: x1, rotate: rotate1, opacity: opacity1, scaleX: -1, filter: 'contrast(1.1) brightness(1.1) saturate(1.4)' }} src="/assets/broccoli.png" alt="" className="absolute top-[10%] left-[8%] sm:left-[15%] w-64 h-auto blur-[1px]" />
         <motion.img style={{ y: y2, x: x2, rotate: rotate2, opacity: opacity2, filter: 'contrast(1.1) brightness(1.1) saturate(1.4)' }} src="/assets/carrot.png" alt="" className="absolute top-[25%] right-[5%] sm:right-[10%] w-72 h-auto blur-[1px]" />
         <motion.img style={{ y: y3, x: x3, rotate: rotate3, opacity: opacity3, filter: 'contrast(1.1) brightness(1.1) saturate(1.4)' }} src="/assets/onion.png" alt="" className="absolute top-[50%] left-[20%] sm:left-[30%] w-48 h-auto" />
         <motion.img style={{ y: y4, x: x4, rotate: rotate4, opacity: opacity4, filter: 'contrast(1.1) brightness(1.1) saturate(1.4)' }} src="/assets/eggplant.png" alt="" className="absolute bottom-[25%] right-[15%] sm:right-[25%] w-64 h-auto blur-[2px]" />
         <motion.img style={{ y: y5, x: x5, rotate: rotate5, opacity: opacity5, filter: 'contrast(1.1) brightness(1.1) saturate(1.4)' }} src="/assets/bellpepper.png" alt="" className="absolute top-[65%] left-[5%] sm:left-[15%] w-56 h-auto blur-[1px]" />
         <motion.img style={{ y: y6, x: x6, rotate: rotate6, opacity: opacity6, filter: 'contrast(1.1) brightness(1.1) saturate(1.4)' }} src="/assets/garlic.png" alt="" className="absolute bottom-[5%] right-[30%] w-40 h-auto" />
         <motion.img style={{ y: y7, x: x7, rotate: rotate7, opacity: opacity7, filter: 'contrast(1.1) brightness(1.1) saturate(1.4)' }} src="/assets/tomato.png" alt="" className="absolute top-[25%] right-[25%] sm:right-[35%] w-56 h-auto blur-[2px]" />
         <motion.img style={{ y: y8, x: x8, rotate: rotate8, opacity: opacity8, filter: 'contrast(1.1) brightness(1.1) saturate(1.4)' }} src="/assets/carrot.png" alt="" className="absolute top-[40%] left-[15%] sm:left-[38%] w-48 h-auto blur-[1px]" />
      </div>
